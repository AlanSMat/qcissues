...
function cs_initListGroup(content,mode) {  
  ...
  //alert(cs_getOptions(content.menu));
...
function initListGroup(n) {
  ...
  var c_prefix=initListGroup.arguments[4];	
  if(!c_prefix)
    c_prefix=initListGroup.arguments[3]; 
  if (_content!=null) {
    content=new cs_contentOBJ(c_prefix+"_"+n,_content.menu);
