...
<form name="qccform" method="post" action="search_results.php?pageid=search&admin=1&qcoperator=1">
  <input type="hidden" name="issue_id" value="<?php echo $issue_id ?>" />
  <input type="hidden" name="qcc_submitted" value="1" />
  <div class="mainFormContainer">
    <div class="row">
      <div class="formLeftColumn">Department *</div>
    ...
    <div class="row">
      ...
      <div class="formRightColumn" style="width:135px;"><?php $calendar->input("qcc_pubdate", $pub_date); ?></div>
    ...
    <div class="row">
      <div class="formLeftColumn">QC Operator *</div>
      <div style="float:left">
  	    <select name="qcc_operator">
  	      <option value=""> -- select qc operator -- </option>
  	      <?php
      ...
      <div style="padding:10px 0px 0px 0px">
        <div class="row" style="padding:10px 0px 0px 0px">
          <div class="formLeftColumn">Error Details *</div>
          <div class="formRightColumn"><textarea name= "qcc_errordetails" rows="2" cols="20" class="textBox" style="height:100px;width:500px;"><?php echo $_SESSION["qcissues"]["qcc_errordetails"] ?></textarea></div>
        </div>
        <div class="row" style="padding-top:5px;">
          <div class="formLeftColumn">&nbsp;</div>
    	  <div class="formRightColumn"><input type="submit" value="Submit Form" class="button"></div>
        </div>
      </div>
    </div>
  </div>
